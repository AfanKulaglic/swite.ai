      ...
      <div className="relative z-10 h-screen flex flex-col items-center justify-center px-6 py-8">
        {step === 'chat' && (
          <div className="w-full max-w-6xl h-full flex flex-col">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 border border-[#4169E1]/20 bg-gradient-to-r from-[#4169E1]/5 to-[#6B46C1]/5 opacity-0 animate-fade-slide-down" style={{ animationDelay: '0s', animationFillMode: 'forwards' }}>
              ...
              <h1 className="text-[clamp(2.5rem,5vw,4rem)] font-light tracking-tight leading-[0.95] mb-4 opacity-0 animate-fade-slide-up" style={{ animationDelay: '0.15s', animationFillMode: 'forwards' }}>
                <span className="block text-white/40">Build websites</span>
                <span className="block font-medium text-white">in seconds</span>
              </h1>
              <p className="text-base text-white/40 max-w-xl mx-auto font-light opacity-0 animate-fade-slide-up" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
            ...
            <div className="border-t border-[#4169E1]/10 pt-6 opacity-0 animate-fade-slide-up" style={{ animationDelay: '0.45s', animationFillMode: 'forwards' }}>
              <div className="max-w-3xl mx-auto">
                <div className="flex gap-3 mb-4">
                  ...
                  <button
                    ...
                    className="px-8 py-3 bg-gradient-to-r from-[#4169E1] to-[#6B46C1] text-white text-sm font-medium tracking-wide hover:opacity-90 disabled:opacity-30 disabled:cursor-not-allowed transition-all duration-300 relative overflow-hidden group"
                  >
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  {[
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 border border-[#4169E1]/20 text-[11px] text-white/40 hover:text-white hover:border-[#4169E1]/40 hover:bg-[#4169E1]/5 transition-all duration-300 font-light tracking-wide opacity-0 animate-fade-scale-in"
                      style={{ animationDelay: `${0.6 + index * 0.08}s`, animationFillMode: 'forwards' }}
                    >
                      {prompt}
                    </button>
                  ))}
            ...
            {/* Footer Note - Compact */}
            <div className="mt-4 text-center opacity-0 animate-fade-in" style={{ animationDelay: '0.9s', animationFillMode: 'forwards' }}>
        ...
        {step === 'template' && (
          <div className="w-full max-w-7xl h-full flex flex-col">
            {/* Header - Compact */}
            <div className="text-center mb-6 opacity-0 animate-fade-slide-down" style={{ animationDelay: '0s', animationFillMode: 'forwards' }}>
            ...
            <div className="flex-1 min-h-0 opacity-0 animate-fade-scale-in" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
              <div
              ...
              >
                ...
                <div className="relative h-full flex flex-col overflow-hidden border border-white/10 group-hover:border-[#4169E1]/40 transition-all duration-500 bg-white/[0.02] backdrop-blur-xl group-hover:scale-[1.01] group-hover:shadow-2xl group-hover:shadow-[#4169E1]/10">
                  ...
                  <div className="flex-1 min-h-0 bg-black relative overflow-hidden">
                    <iframe
                      ...
                      className="w-full h-full pointer-events-none scale-[0.5] origin-top-left transition-transform duration-700 group-hover:scale-[0.52]"
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-[#4169E1]/90 to-[#6B46C1]/90 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center">
                      <div className="text-center transform scale-90 group-hover:scale-100 transition-transform duration-500">
                        <div className="w-16 h-16 border border-white/20 flex items-center justify-center mx-auto mb-4 backdrop-blur-sm group-hover:border-white/40 transition-colors duration-500">
                  ...
                  {/* Info - Compact */}
                  <div className="p-6 border-t border-white/10 flex items-center justify-between gap-6 bg-black/40 backdrop-blur-sm">
                    <div className="flex-1">
                    ...
                    <div className="flex gap-2 items-center">
                      {['Hero', 'Features', 'Pricing', 'Reviews', 'Contact'].map((item, index) => (
                        <div 
                          key={item} 
                          className="px-2 py-1 border border-white/10 text-[10px] text-white/40 font-light tracking-wide opacity-0 animate-fade-scale-in group-hover:border-[#4169E1]/20 transition-colors duration-500"
                    ...
                    {/* CTA - Compact */}
                    <button className="px-6 py-3 bg-gradient-to-r from-[#4169E1] to-[#6B46C1] text-white font-medium hover:opacity-90 transition-all duration-300 text-xs tracking-wide flex items-center gap-2 group/btn whitespace-nowrap relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-[#6B46C1] to-[#4169E1] opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300" />
            ...
            {/* Back Button - Minimal */}
            <div className="mt-4 flex justify-center opacity-0 animate-fade-in" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
              <button
