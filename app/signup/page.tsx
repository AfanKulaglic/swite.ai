        ...
        <div className="w-full max-w-md py-8">
          ...
          <div className="mb-12">
            <h1 className="text-[clamp(2rem,5vw,3rem)] font-light tracking-tight leading-[0.95] mb-3">
              <span className="block text-white/40">Start building</span>
              <span className="block font-medium text-white">today</span>
            </h1>
          ...
          {/* Success Message */}
          {success && (
            <div className="mb-6 p-4 bg-green-500/10 border border-green-500/20 text-green-400 text-sm">
              {success}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mb-8">
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
              />
              <p className="text-[10px] text-white/30 mt-2 uppercase tracking-wider">Min 8 characters</p>
            </div>
            ...
            <div className="flex items-start gap-3 pt-2">
              <input
                ...
                className="mt-1 w-4 h-4 border-white/10 bg-white/5"
              />
              <label htmlFor="terms" className="text-xs text-white/40 font-light">
                I agree to the{" "}
          ...
          {/* Social Signup - Placeholder for future implementation */}
          <div className="space-y-3 mb-8">
            <button 
              type="button"
              className="w-full px-4 py-3 bg-white/5 border border-white/10 hover:bg-white/10 hover:border-[#4169E1]/40 transition-all duration-300 flex items-center justify-center gap-3 text-sm font-light opacity-50 cursor-not-allowed"
              disabled
            >
        ...
        <div className="relative z-20 h-full flex flex-col items-center justify-center p-12 text-center">
          <div className="max-w-lg">
            ...
            <h2 className="text-[clamp(2rem,4vw,3rem)] font-light tracking-tight leading-tight mb-6">
              <span className="block text-white/40">Launch your site</span>
              <span className="block font-medium text-white">in 15 minutes</span>
            </h2>
            ...
            <div className="space-y-4 text-left">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  <div className="w-5 h-5 border border-[#4169E1]/30 bg-gradient-to-br from-[#4169E1]/10 to-[#6B46C1]/10 flex items-center justify-center flex-shrink-0">
