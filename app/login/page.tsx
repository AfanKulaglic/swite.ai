  ...
  return (
    <div className="h-screen flex overflow-hidden bg-black text-white">
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        {/* Animated gradient orbs - Cyan/Teal theme */}
        <div className="absolute top-1/4 right-1/4 w-[600px] h-[600px] bg-gradient-to-br from-cyan-500/12 to-teal-500/10 rounded-full blur-3xl animate-float-orb" />
        <div className="absolute bottom-1/4 left-1/4 w-[500px] h-[500px] bg-gradient-to-br from-teal-500/15 to-emerald-500/10 rounded-full blur-3xl animate-float-orb-2" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-r from-sky-500/10 to-cyan-500/8 rounded-full blur-3xl animate-float-orb-3" />
