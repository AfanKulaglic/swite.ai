...
export default function Home() {
  ...
  return (
    <main className="w-full bg-black text-white overflow-hidden">
      ...
      <section className="relative min-h-[85vh] sm:min-h-screen flex items-start sm:items-center justify-center overflow-hidden pt-20 sm:pt-32 lg:pt-0">
        {/* Animated grid background */}
        <div className="absolute inset-0 bg-[linear-gradient(rgba(65,105,225,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(65,105,225,0.03)_1px,transparent_1px)] bg-[size:50px_50px] lg:bg-[size:100px_100px] [mask-image:radial-gradient(ellipse_at_center,black,transparent_80%)] animate-pulse-glow-soft" />
        
        {/* Multiple animated gradient orbs - repositioned for mobile */}
        <div className="absolute top-10 right-0 w-[300px] h-[300px] lg:top-1/4 lg:right-1/4 lg:w-[700px] lg:h-[700px] bg-gradient-to-br from-blue-500/20 via-cyan-500/15 to-transparent rounded-full blur-3xl animate-float-orb" />
        <div className="absolute bottom-20 left-0 w-[250px] h-[250px] lg:bottom-1/4 lg:left-1/4 lg:w-[600px] lg:h-[600px] bg-gradient-to-tr from-purple-500/18 via-pink-500/12 to-transparent rounded-full blur-3xl animate-float-orb-2" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] lg:w-[500px] lg:h-[500px] bg-gradient-to-r from-indigo-500/15 to-violet-500/15 rounded-full blur-3xl animate-float-orb-3" />
        
        {/* Floating particles effect - hidden on mobile */}
        <div className="hidden lg:block absolute top-1/3 left-1/3 w-2 h-2 bg-blue-400/30 rounded-full blur-sm animate-pulse-glow-soft" />
        <div className="hidden lg:block absolute top-2/3 right-1/3 w-2 h-2 bg-purple-400/30 rounded-full blur-sm animate-pulse-glow-soft" style={{ animationDelay: '2s' }} />
        <div className="hidden lg:block absolute bottom-1/3 left-2/3 w-2 h-2 bg-cyan-400/30 rounded-full blur-sm animate-pulse-glow-soft" style={{ animationDelay: '4s' }} />
        
        {/* Minimal accent line with gradient - hidden on mobile */}
        <div className="hidden lg:block absolute top-0 left-1/2 w-px h-32 bg-gradient-to-b from-[#4169E1]/30 via-[#6B46C1]/30 to-transparent" />
        
        {/* Diagonal accent lines for mobile */}
        <div className="lg:hidden absolute top-32 right-0 w-24 h-px bg-gradient-to-l from-[#4169E1]/30 to-transparent" />
        <div className="lg:hidden absolute bottom-32 left-0 w-32 h-px bg-gradient-to-r from-[#6B46C1]/30 to-transparent" />
        
        <div ref={heroRef} className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center lg:text-center">
          {/* Minimal badge with gradient accent - offset on mobile */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 mb-8 sm:mb-12 border border-[#4169E1]/20 rounded-full bg-gradient-to-r from-[#4169E1]/5 to-[#6B46C1]/5 lg:mx-auto">
            <div className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-[#4169E1] to-[#6B46C1] animate-pulse" />
            <span className="text-[10px] sm:text-xs font-medium text-white/60 tracking-wider uppercase">AI Website Builder</span>
          </div>

          {/* Main headline - Asymmetric on mobile */}
          <h1 className="text-[clamp(2.5rem,12vw,7rem)] font-light tracking-tight leading-[0.95] mb-6 sm:mb-8">
            <span className="block text-white/40 text-left lg:text-center">Build websites</span>
            <span className="block font-medium text-white text-right lg:text-center">in seconds</span>
          </h1>

          {/* Subheadline - Minimal - with decorative element on mobile */}
          <div className="relative mb-10 sm:mb-16">
            <div className="lg:hidden absolute -left-2 top-0 w-1 h-full bg-gradient-to-b from-[#4169E1] to-[#6B46C1] rounded-full" />
            <p className="text-base sm:text-lg text-white/40 max-w-xl mx-auto font-light px-4 lg:px-0 leading-relaxed text-left lg:text-center">
              Enterprise-grade AI that transforms ideas into production-ready websites. 
              No code. No complexity.
            </p>
          </div>

          {/* CTA - Modern card layout on mobile */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 mb-16 sm:mb-24 px-4">
            <Link
              href="/studio"
              className="group relative px-8 py-4 bg-gradient-to-r from-[#4169E1] to-[#6B46C1] text-white text-sm font-medium tracking-wide hover:opacity-90 transition-all duration-300 text-center overflow-hidden"
            >
              ...
              <div className="lg:hidden absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full blur-2xl -translate-y-10 translate-x-10" />
            ...
            <div className="grid grid-cols-2 gap-3 sm:flex sm:gap-4">
              <Link
                href="/documentation"
                className="px-6 sm:px-8 py-4 border border-[#4169E1]/20 text-sm font-medium text-white/60 hover:text-white hover:border-[#4169E1]/40 hover:bg-[#4169E1]/5 transition-all duration-300 tracking-wide text-center"
              >
                Docs
              </Link>
          ...
          {/* Minimal stats - Card style on mobile */}
          <div className="grid grid-cols-3 gap-3 sm:gap-8 max-w-4xl mx-auto px-2">
            <div className="group relative bg-white/[0.02] border border-[#4169E1]/10 rounded-2xl p-4 sm:p-0 sm:bg-transparent sm:border-0 hover:border-[#4169E1]/30 transition-all">
              <div className="text-2xl sm:text-3xl font-light mb-1 sm:mb-2 bg-gradient-to-r from-[#4169E1] to-[#6B46C1] bg-clip-text text-transparent group-hover:scale-110 transition-transform">50K+</div>
              <div className="text-white/30 text-[10px] sm:text-xs tracking-wider uppercase mb-1 leading-tight">Websites</div>
              <div className="hidden sm:block h-px bg-gradient-to-r from-transparent via-[#4169E1]/30 to-transparent" />
            </div>
            <div className="group relative bg-white/[0.02] border border-[#4169E1]/10 rounded-2xl p-4 sm:p-0 sm:bg-transparent sm:border-0 hover:border-[#4169E1]/30 transition-all">
              <div className="text-2xl sm:text-3xl font-light mb-1 sm:mb-2 bg-gradient-to-r from-[#4169E1] to-[#6B46C1] bg-clip-text text-transparent group-hover:scale-110 transition-transform">99.9%</div>
              <div className="text-white/30 text-[10px] sm:text-xs tracking-wider uppercase mb-1 leading-tight">Uptime</div>
              <div className="hidden sm:block h-px bg-gradient-to-r from-transparent via-[#4169E1]/30 to-transparent" />
            </div>
            <div className="group relative bg-white/[0.02] border border-[#4169E1]/10 rounded-2xl p-4 sm:p-0 sm:bg-transparent sm:border-0 hover:border-[#4169E1]/30 transition-all">
              <div className="text-2xl sm:text-3xl font-light mb-1 sm:mb-2 bg-gradient-to-r from-[#4169E1] to-[#6B46C1] bg-clip-text text-transparent group-hover:scale-110 transition-transform">&lt;30s</div>
              <div className="text-white/30 text-[10px] sm:text-xs tracking-wider uppercase mb-1 leading-tight">Build</div>
              <div className="hidden sm:block h-px bg-gradient-to-r from-transparent via-[#4169E1]/30 to-transparent" />
            </div>
          </div>
        </div>

        {/* Scroll indicator with gradient - hidden on mobile */}
        <div className="hidden lg:flex absolute bottom-12 left-1/2 -translate-x-1/2 flex-col items-center gap-2">
      ...
      {/* Features Grid - Staggered layout on mobile */}
      <section className="relative py-16 sm:py-24 lg:py-32 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] lg:w-[900px] lg:h-[900px] bg-gradient-to-bl from-emerald-500/15 via-green-500/10 to-transparent rounded-full blur-3xl animate-float-orb" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] lg:w-[700px] lg:h-[700px] bg-gradient-to-tr from-teal-500/15 via-cyan-500/10 to-transparent rounded-full blur-3xl animate-float-orb-2" />
        <div className="absolute top-1/2 right-1/3 w-[300px] h-[300px] lg:w-[500px] lg:h-[500px] bg-gradient-to-l from-green-400/12 to-transparent rounded-full blur-3xl animate-float-orb-3" />
        
        <div className="max-w-7xl mx-auto relative z-10">
          {/* Section label with gradient - Asymmetric on mobile */}
          <div className="mb-12 sm:mb-16 lg:mb-20">
            <div className="flex items-center gap-3 mb-3 sm:mb-4">
              <div className="lg:hidden w-8 h-px bg-gradient-to-r from-[#4169E1] to-transparent" />
              <div className="text-xs bg-gradient-to-r from-[#4169E1] to-[#6B46C1] bg-clip-text text-transparent tracking-widest uppercase">Features</div>
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light tracking-tight">
              <span className="block text-white/40 text-left lg:text-left">Everything you need.</span>
              <span className="block text-white text-right lg:text-left">Nothing you don't.</span>
            </h2>
          </div>

          {/* Feature grid - Custom mobile layout: 2-1-2-1 pattern */}
          <div ref={gridRef} className="grid grid-cols-2 gap-px sm:grid-cols-2 sm:gap-px lg:grid-cols-3 bg-gradient-to-br from-[#4169E1]/10 to-[#6B46C1]/10">
            {[
              {
                title: "AI Generation",
              ...
              <div
                key={index}
                className={`group relative bg-black p-6 sm:p-8 lg:p-12 hover:bg-gradient-to-br hover:from-[#4169E1]/[0.02] hover:to-[#6B46C1]/[0.02] transition-all duration-500 
                  ${index === 2 || index === 5 ? 'col-span-2 sm:col-span-1' : 'col-span-1'}
                `}
              >
                {/* Hover effect */}
                ...
                <div className="relative">
                  {/* Icon */}
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-[#4169E1]/10 to-[#6B46C1]/10 border border-[#4169E1]/20 flex items-center justify-center mb-4 sm:mb-6 group-hover:border-[#4169E1]/40 group-hover:scale-110 transition-all duration-500">
                  ...
                  <div className="text-xs text-white/20 group-hover:bg-gradient-to-r group-hover:from-[#4169E1] group-hover:to-[#6B46C1] group-hover:bg-clip-text group-hover:text-transparent font-light mb-3 sm:mb-4 transition-all duration-500">0{index + 1}</div>
                  
                  {/* Title */}
                  <h3 className="text-lg sm:text-xl font-medium mb-2 sm:mb-3 group-hover:text-white transition-colors">{feature.title}</h3>
                  
                  {/* Description */}
                  <p className="text-sm text-white/40 leading-relaxed mb-4 sm:mb-6 font-light group-hover:text-white/60 transition-colors">
                    {feature.description}
                  </p>
                ...
                <div className="absolute top-0 right-0 w-px h-8 sm:h-12 bg-gradient-to-b from-[#4169E1]/30 via-[#6B46C1]/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-16 sm:py-24 lg:py-32 px-4 sm:px-6 border-t border-[#4169E1]/10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="mb-12 sm:mb-16 lg:mb-20 lg:hidden">
            <div className="flex items-center gap-3 mb-3 sm:mb-4">
              <div className="w-8 h-px bg-gradient-to-r from-[#4169E1] to-transparent" />
              <div className="text-xs bg-gradient-to-r from-[#4169E1] to-[#6B46C1] bg-clip-text text-transparent tracking-widest uppercase">Testimonial</div>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light tracking-tight">
              <span className="block text-white/40 text-left">Trusted by</span>
              <span className="block text-white text-right">thousands</span>
            </h2>
          </div>

          <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 items-center">
            {/* Left: Testimonial - Card style on mobile */}
            <div className="group relative bg-black border border-[#4169E1]/10 p-6 sm:p-8 lg:p-0 lg:bg-transparent lg:border-0 hover:bg-gradient-to-br hover:from-[#4169E1]/[0.02] hover:to-[#6B46C1]/[0.02] transition-all duration-500">
              {/* Hover effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#4169E1]/[0.03] to-[#6B46C1]/[0.03] opacity-0 group-hover:opacity-100 transition-opacity duration-500 lg:hidden" />
              
              <div className="relative">
                {/* Desktop label */}
                <div className="hidden lg:block text-xs bg-gradient-to-r from-[#4169E1] to-[#6B46C1] bg-clip-text text-transparent tracking-widest uppercase mb-8">Testimonial</div>
                
                {/* Quote icon - Mobile only */}
                <div className="lg:hidden w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-[#4169E1]/10 to-[#6B46C1]/10 border border-[#4169E1]/20 flex items-center justify-center mb-4 sm:mb-6 group-hover:border-[#4169E1]/40 group-hover:scale-110 transition-all duration-500">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white/60 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                  </svg>
                </div>

                <blockquote className="text-lg sm:text-2xl lg:text-3xl font-light leading-relaxed mb-6 sm:mb-8 lg:mb-12 text-white/80 group-hover:text-white transition-colors">
                  "SWITE.AI reduced our deployment time from weeks to minutes. 
                  The ROI was immediate and undeniable."
                </blockquote>

                <div className="flex items-center gap-4 pt-4 sm:pt-6 lg:pt-0 border-t border-[#4169E1]/10 lg:border-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#4169E1]/20 to-[#6B46C1]/20 border border-[#4169E1]/20 flex items-center justify-center group-hover:border-[#4169E1]/40 transition-colors duration-500">
                  ...
                  <div>
                    <div className="font-medium text-sm sm:text-base">Sarah Chen</div>
                    <div className="text-xs sm:text-sm text-white/40">CTO, TechVentures</div>
                  </div>
                </div>

                {/* Corner accent - Mobile only */}
                <div className="lg:hidden absolute top-0 right-0 w-px h-8 sm:h-12 bg-gradient-to-b from-[#4169E1]/30 via-[#6B46C1]/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>
            </div>

            {/* Right: Metrics - Same grid style as features */}
            <div className="grid grid-cols-2 gap-px bg-gradient-to-br from-[#4169E1]/10 to-[#6B46C1]/10">
              {[
                ...
                <div key={index} className="group relative bg-black p-6 sm:p-8 hover:bg-gradient-to-br hover:from-[#4169E1]/[0.02] hover:to-[#6B46C1]/[0.02] transition-all duration-500">
                  {/* Hover effect */}
                  <div className="absolute inset-0 bg-gradient-to-br from-[#4169E1]/[0.03] to-[#6B46C1]/[0.03] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  ...
                  <div className="relative">
                    ...
                    <div className="text-2xl sm:text-3xl lg:text-4xl font-light mb-2 bg-gradient-to-r from-[#4169E1] to-[#6B46C1] bg-clip-text text-transparent group-hover:scale-105 transition-transform">{stat.value}</div>
                    <div className="text-xs sm:text-sm text-white/60 font-medium mb-1">{stat.label}</div>
                    <div className="text-[10px] sm:text-xs text-white/30 tracking-wider uppercase">{stat.sublabel}</div>
                  </div>
      ...
      <section className="relative py-16 sm:py-24 lg:py-32 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(rgba(139,92,246,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(139,92,246,0.02)_1px,transparent_1px)] bg-[size:40px_40px] sm:bg-[size:80px_80px] animate-pulse-glow-soft" />
        
        {/* Large central orb with purple/pink theme */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] lg:w-[1000px] lg:h-[1000px] bg-gradient-to-br from-purple-500/18 via-violet-500/12 to-fuchsia-500/15 rounded-full blur-3xl animate-float-orb" />
        <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] lg:w-[700px] lg:h-[700px] bg-gradient-to-bl from-pink-500/15 via-purple-400/10 to-transparent rounded-full blur-3xl animate-float-orb-2" />
        <div className="absolute bottom-1/4 left-1/4 w-[300px] h-[300px] lg:w-[600px] lg:h-[600px] bg-gradient-to-tr from-violet-500/15 via-indigo-500/10 to-transparent rounded-full blur-3xl animate-float-orb-3" />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="mb-12 sm:mb-16 lg:mb-20">
            <div className="flex items-center gap-3 mb-3 sm:mb-4">
              <div className="lg:hidden w-8 h-px bg-gradient-to-r from-[#4169E1] to-transparent" />
              <div className="text-xs bg-gradient-to-r from-[#4169E1] to-[#6B46C1] bg-clip-text text-transparent tracking-widest uppercase">How It Works</div>
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light tracking-tight">
              <span className="block text-white/40 text-left lg:text-left">From idea to live site.</span>
              <span className="block text-white text-right lg:text-left">In three steps.</span>
            </h2>
          </div>

          {/* Process Cards - Mobile: 1 column, Tablet: 2 columns, Desktop: 3 columns */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-px bg-gradient-to-br from-[#4169E1]/10 to-[#6B46C1]/10 mb-12 sm:mb-16">
            {[
              {
                step: "01",
              ...
              <div key={index} className="group relative bg-black p-6 sm:p-8 lg:p-12 hover:bg-gradient-to-br hover:from-[#4169E1]/[0.02] hover:to-[#6B46C1]/[0.02] transition-all duration-500">
                {/* Hover effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#4169E1]/[0.03] to-[#6B46C1]/[0.03] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                ...
                <div className="relative">
                  ...
                  {/* Number with gradient on hover */}
                  <div className="text-xs text-white/20 group-hover:bg-gradient-to-r group-hover:from-[#4169E1] group-hover:to-[#6B46C1] group-hover:bg-clip-text group-hover:text-transparent font-light mb-3 sm:mb-4 transition-all duration-500">{item.step}</div>
                  
                  {/* Title */}
                  <h3 className="text-lg sm:text-xl font-medium mb-2 sm:mb-3 group-hover:text-white transition-colors">{item.title}</h3>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {item.features.map((feature, idx) => (
                      <span key={idx} className="inline-flex items-center gap-2 px-2.5 py-1 border border-[#4169E1]/20 text-[10px] sm:text-xs font-medium group-hover:border-[#4169E1]/40 group-hover:bg-[#4169E1]/5 transition-all duration-500">
                        <div className="w-1 h-1 rounded-full bg-gradient-to-r from-[#4169E1] to-[#6B46C1]" />
                        <span className="text-white/60 group-hover:text-white/80">{feature}</span>
                      </span>
                    ))}
                  </div>
                </div>
          ...
          {/* Bottom Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-gradient-to-r from-[#4169E1]/10 to-[#6B46C1]/10">
            {[
              ...
              <div key={index} className="group relative bg-black p-6 sm:p-8 hover:bg-gradient-to-br hover:from-[#4169E1]/[0.02] hover:to-[#6B46C1]/[0.02] transition-all duration-500">
                ...
                <div className="relative text-center lg:text-center">
                  ...
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-light mb-2 bg-gradient-to-r from-[#4169E1] to-[#6B46C1] bg-clip-text text-transparent group-hover:scale-110 transition-transform">
                    {stat.value}
                  </div>
                  <div className="text-xs sm:text-sm text-white font-medium mb-1">{stat.label}</div>
      ...
      <section className="relative py-16 sm:py-24 lg:py-32 px-4 sm:px-6 border-t border-[#4169E1]/10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="mb-12 sm:mb-16 lg:mb-20">
            <div className="flex items-center gap-3 mb-3 sm:mb-4">
              <div className="lg:hidden w-8 h-px bg-gradient-to-r from-[#4169E1] to-transparent" />
              <div className="text-xs bg-gradient-to-r from-[#4169E1] to-[#6B46C1] bg-clip-text text-transparent tracking-widest uppercase">Studio</div>
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light tracking-tight">
              <span className="block text-white/40 text-left lg:text-left">Powerful editor.</span>
              <span className="block text-white text-right lg:text-left">Intuitive interface.</span>
            </h2>
          </div>
      ...
      <section className="relative py-16 sm:py-24 lg:py-32 px-4 sm:px-6 border-t border-[#4169E1]/10 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="mb-12 sm:mb-16 lg:mb-20">
            <div className="flex items-center gap-3 mb-3 sm:mb-4">
              <div className="lg:hidden w-8 h-px bg-gradient-to-r from-[#4169E1] to-transparent" />
              <div className="text-xs bg-gradient-to-r from-[#4169E1] to-[#6B46C1] bg-clip-text text-transparent tracking-widest uppercase">FAQ</div>
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light tracking-tight">
              <span className="block text-white/40 text-left lg:text-left">Questions?</span>
              <span className="block text-white text-right lg:text-left">We have answers.</span>
            </h2>
          </div>
