...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Navigation - Top Bar (Always Visible) */}
      <nav className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-2xl border-b border-[#4169E1]/20">
        <div className="px-4 py-4">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/" className="flex items-center gap-2">
              <div className="relative">
                <div className="absolute -inset-2 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-xl blur-lg opacity-75 animate-pulse" />
                <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 via-blue-600 to-purple-600 shadow-xl shadow-blue-500/50 overflow-hidden">
                  <Image 
                    src="/logo.png" 
                    alt="SWITE.AI Logo" 
                    fill
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                href="/studio"
                className="px-4 py-2 rounded-xl bg-gradient-to-r from-[#4169E1] to-[#6B46C1] text-white text-sm font-medium shadow-lg shadow-[#4169E1]/30 hover:shadow-[#4169E1]/50 transition-all duration-300"
              >
                Start Free
              </Link>
            </div>
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-xl whitespace-nowrap transition-all duration-300 ${
                  isActive(link.href)
                    ? "bg-gradient-to-r from-[#4169E1] to-[#6B46C1] text-white shadow-lg shadow-[#4169E1]/30"
        ...
        <div 
          className={`overflow-hidden transition-all duration-300 border-t border-[#4169E1]/10 ${
            expandedMobile === 'menu' ? 'max-h-[70vh]' : 'max-h-0'
          }`}
        >
                ...
                <div className="space-y-1 pl-7">
                  {menu.links.map((link) => (
                    <Link
                      ...
                      className={`block px-4 py-2.5 rounded-xl text-sm transition-all duration-200 ${
                        isActive(link.href)
                          ? "bg-gradient-to-r from-[#4169E1] to-[#6B46C1] text-white shadow-lg shadow-[#4169E1]/20"
