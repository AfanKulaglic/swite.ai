...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 py-20 px-6 relative bg-black">
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="grid md:grid-cols-6 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-white/50 leading-relaxed mb-6 max-w-xs">
              Professional website builder powered by AI. Weaving the web, one site at a time.
            </p>
            {/* Social Links */}
          ...
          {Object.entries(links).map(([category, items]) => (
            <div key={category}>
              <div className="text-sm font-bold mb-4 text-white/90">{category}</div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/40">
            © 2024 SWITE.AI. All rights reserved.
          </p>
